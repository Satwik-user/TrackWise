                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {errors.train_number && (
                      <p className="mt-1 text-sm text-red-600 flex items-center">
                        ...
                        {typeof errors.train_number === 'string' ? errors.train_number : JSON.stringify(errors.train_number)}
                      </p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.train_name && (
                      <p className="mt-1 text-sm text-red-600 flex items-center">
                        <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                        {typeof errors.train_name === 'string' ? errors.train_name : JSON.stringify(errors.train_name)}
                      </p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.priority && (
                      <p className="mt-1 text-sm text-red-600 flex items-center">
                        <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                        {typeof errors.priority === 'string' ? errors.priority : JSON.stringify(errors.priority)}
                      </p>
                    )}
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {errors.length && (
                      <p className="mt-1 text-sm text-red-600 flex items-center">
                        <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                        {typeof errors.length === 'string' ? errors.length : JSON.stringify(errors.length)}
                      </p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.max_speed && (
                      <p className="mt-1 text-sm text-red-600 flex items-center">
                        <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                        {typeof errors.max_speed === 'string' ? errors.max_speed : JSON.stringify(errors.max_speed)}
                      </p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.acceleration && (
                      <p className="mt-1 text-sm text-red-600 flex items-center">
                        <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                        {typeof errors.acceleration === 'string' ? errors.acceleration : JSON.stringify(errors.acceleration)}
                      </p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.deceleration && (
                      <p className="mt-1 text-sm text-red-600 flex items-center">
                        <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                        {typeof errors.deceleration === 'string' ? errors.deceleration : JSON.stringify(errors.deceleration)}
                      </p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.weight && (
                      <p className="mt-1 text-sm text-red-600 flex items-center">
                        <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                        {typeof errors.weight === 'string' ? errors.weight : JSON.stringify(errors.weight)}
                      </p>
                    )}
                  </div>
                  ...
                  {['EXPRESS', 'SUBURBAN', 'SPECIAL'].includes(formData.train_type) && (
                    <div>
                      ...
                      {errors.passenger_capacity && (
                        <p className="mt-1 text-sm text-red-600 flex items-center">
                          <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                          {typeof errors.passenger_capacity === 'string' ? errors.passenger_capacity : JSON.stringify(errors.passenger_capacity)}
                        </p>
                      )}
                    </div>
                  )}
                  ...
                  {['FREIGHT', 'SPECIAL'].includes(formData.train_type) && (
                    <div>
                      ...
                      {errors.cargo_capacity && (
                        <p className="mt-1 text-sm text-red-600 flex items-center">
                          <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                          {typeof errors.cargo_capacity === 'string' ? errors.cargo_capacity : JSON.stringify(errors.cargo_capacity)}
                        </p>
                      )}
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    {errors.energy_efficiency && (
                      <p className="mt-1 text-sm text-red-600 flex items-center">
                        <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                        {typeof errors.energy_efficiency === 'string' ? errors.energy_efficiency : JSON.stringify(errors.energy_efficiency)}
                      </p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.punctuality_score && (
                      <p className="mt-1 text-sm text-red-600 flex items-center">
                        <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                        {typeof errors.punctuality_score === 'string' ? errors.punctuality_score : JSON.stringify(errors.punctuality_score)}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {errors.scheduled_departure && (
                      <p className="mt-1 text-sm text-red-600 flex items-center">
                        <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                        {typeof errors.scheduled_departure === 'string' ? errors.scheduled_departure : JSON.stringify(errors.scheduled_departure)}
                      </p>
                    )}
                  </div>
