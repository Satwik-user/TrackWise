                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      {errors.section_code && (
                        <p className="mt-1 text-sm text-red-600 flex items-center">
                          ...
                          {typeof errors.section_code === 'string' ? errors.section_code : JSON.stringify(errors.section_code)}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {errors.section_name && (
                        <p className="mt-1 text-sm text-red-600 flex items-center">
                          <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                          {typeof errors.section_name === 'string' ? errors.section_name : JSON.stringify(errors.section_name)}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {errors.max_occupancy && (
                        <p className="mt-1 text-sm text-red-600 flex items-center">
                          <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                          {typeof errors.max_occupancy === 'string' ? errors.max_occupancy : JSON.stringify(errors.max_occupancy)}
                        </p>
                      )}
                    </div>
                    ...
                    {section && (
                      <div>
                        ...
                        {errors.current_occupancy && (
                          <p className="mt-1 text-sm text-red-600 flex items-center">
                            <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                            {typeof errors.current_occupancy === 'string' ? errors.current_occupancy : JSON.stringify(errors.current_occupancy)}
                          </p>
                        )}
                      </div>
                    )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      {errors.track_count && (
                        <p className="mt-1 text-sm text-red-600 flex items-center">
                          <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                          {typeof errors.track_count === 'string' ? errors.track_count : JSON.stringify(errors.track_count)}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {errors.platform_count && (
                        <p className="mt-1 text-sm text-red-600 flex items-center">
                          <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                          {typeof errors.platform_count === 'string' ? errors.platform_count : JSON.stringify(errors.platform_count)}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {errors.gradient && (
                        <p className="mt-1 text-sm text-red-600 flex items-center">
                          <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                          {typeof errors.gradient === 'string' ? errors.gradient : JSON.stringify(errors.gradient)}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {errors.curve_radius && (
                        <p className="mt-1 text-sm text-red-600 flex items-center">
                          <ExclamationTriangleIcon className="h-4 w-4 mr-1" />
                          {typeof errors.curve_radius === 'string' ? errors.curve_radius : JSON.stringify(errors.curve_radius)}
                        </p>
                      )}
                    </div>
